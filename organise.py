...
from_dir = "C:/Users/deves/Downloads"
to_dir = "C:/Users/deves/Downloads"
...
for file_name in list_of_files:
    ...
    if extension in ['.exe']:
        ...
        path2 = to_dir + '/' + "software"                     # Example path2 : D:/My Files/Image_Files      
        path3 = to_dir + '/' + "software" + '/' + file_name   # Example path3 : D:/My Files/Image_Files/ImageName1.jpg
        #print("path1 " , path1)
        #print("path3 ", path3)
